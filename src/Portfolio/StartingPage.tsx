...
const StartingSection: React.FC = () => {
  return (
    <div className="mx-8 my-6">
      ...
      <img src={startedimg} alt="" className="h-8" />
      ...
      <p className="text-gray-300 mt-2 ">
        ...
        started in the world of crypto, Crypto Scope empowers you to stay on top
      ...
      <div className="mt-6">
        ...
        <ol className="list-decimal text-gray-300 mt-4 ml-6">
          ...
          <li>
            ...
            in, head over to the Lists section to create your first list. Lists
            are customizable collections where you can organize your favorite
            cryptocurrencies and set targets for each.
          </li>
          <li>
      ...
      <div className="mt-6">
        ...
        <ul className="list-disc text-gray-300 mt-4 ml-6">
          <li>
            ...
            market movements with customizable alerts. Set up notifications for
            specific coins or market conditions to never miss a beat.
          </li>
          <li>
            Portfolio Analysis: Dive deep into your portfolio's performance with
            comprehensive analysis tools. Identify trends, track your gains and
            losses, and optimize your investment strategy for maximum returns.
          </li>
          <li>
