...
const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="text-gray-300 flex justify-between items-center rounded-sm hover:bg-gray-900 px-2 py-1 hover:cursor-pointer">
        <Link to="/Portfolio/list" className="flex items-center gap-1">
          <p className="text-gray-200 text-md">Lists</p>
          <p className="text-gray-400 text-xs">browse </p>
        </Link>
